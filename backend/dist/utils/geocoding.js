...
exports.MATERIAL_ORIGINS = void 0;
exports.getMaterialOrigins = getMaterialOrigins;
exports.getAllKnownMaterials = getAllKnownMaterials;
exports.MATERIAL_ORIGINS = {
    'Lithium': [
...
function getMaterialOrigins(material) {
    // Try exact match first
    if (exports.MATERIAL_ORIGINS[material]) {
        return exports.MATERIAL_ORIGINS[material];
    }
    // Try case-insensitive match
    const normalizedMaterial = material.toLowerCase();
    for (const [key, origins] of Object.entries(exports.MATERIAL_ORIGINS)) {
    ...
    // Try partial match
    for (const [key, origins] of Object.entries(exports.MATERIAL_ORIGINS)) {
        if (key.toLowerCase().includes(normalizedMaterial) ||
...
function getAllKnownMaterials() {
    return Object.keys(exports.MATERIAL_ORIGINS);
}
